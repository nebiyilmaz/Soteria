...
$CriticalIssuesJQL = array(
    'jql' => '"Epic Link"=SB-241 and priority in(Highest) '
);

$HighIssuesJQL = array(
    'jql' => '"Epic Link"=SB-241 and priority in(High) '
);

$MediumIssuesJQL = array(
    'jql' => '"Epic Link"=SB-241 and priority in(Medium) '
);

$LowIssuesJQL = array(
    'jql' => '"Epic Link"=SB-241 and priority in(Low) '
);

$InfoIssuesJQL = array(
    'jql' => '"Epic Link"=SB-241 and priority in(Lowest) '
);
